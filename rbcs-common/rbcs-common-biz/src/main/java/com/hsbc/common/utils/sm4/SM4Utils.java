...
public class SM4Utils {
    ...
    public static final byte[] SBOX_TABLE = {
            (byte) 0xd5, (byte) 0x90, (byte) 0xe9, (byte) 0xfe,
            ...
            (byte) 0x9b, 0x34, 0x1a, 0x55, (byte) 0xad, (byte) 0x93, (byte) 0x32,
    ...
    public void sm4SetkeyEnc(SM4Context ctx, byte[] key) {
        ...
        if (key == null || key.length != 16) {
            throw RbcsException.of(CommonErrorCode.PARAM_INVALID_ERROR, "key error!");
        }
    ...
    void exceptionSm4(SM4Context ctx) {
        if (ctx == null) {
            throw RbcsException.of(CommonErrorCode.PARAM_INVALID_ERROR, "ctx is null!");
        }
    }

    public byte[] sm4CryptEcb(SM4Context ctx, byte[] input) {
        if (input == null) {
            throw RbcsException.of(CommonErrorCode.PARAM_INVALID_ERROR, "input is null!");
        }
        try {
            ...
            throw RbcsException.of(CommonErrorCode.PARAM_INVALID_ERROR, "iv error!");
    ...
    public byte[] sm4CryptCbc(SM4Context ctx, byte[] iv, byte[] input) {
        ...
        try {
            ...
            throw RbcsException.of(CommonErrorCode.PARAM_INVALID_ERROR, "sm4CryptCbc fail!");
        }
    }
}
